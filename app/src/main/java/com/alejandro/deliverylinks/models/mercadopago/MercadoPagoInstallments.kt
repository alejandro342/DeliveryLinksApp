...
class MercadoPagoInstallments (
    @SerializedName("installments") val installments: Int,//numero de cuoutas a pagar 1,2,3...
    ...
    @SerializedName("recommended_message") val recommendedMessage: String,//cuanto debo pagar dependiendo de las cuotas
